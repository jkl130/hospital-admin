        ...
        <div class="tabBody">
          ...
          <el-row>
            <el-radio v-model="day.cronEvery" label="2"
              ...
              <el-select size="small" v-model="week.incrementIncrement">
                <el-option
                  v-for="(val, index) in 7"
                  :key="index"
                  :label="text.Week[index]"
    ...
    secondsText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "2":
          ...
          break;
        case "3":
          seconds = this.second.specificSpecific.join();
          break;
        case "4":
    ...
    minutesText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "2":
          ...
          break;
        case "3":
          minutes = this.minute.specificSpecific.join();
          break;
        case "4":
    ...
    hoursText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "2":
          ...
          break;
        case "3":
          hours = this.hour.specificSpecific.join();
          break;
        case "4":
    ...
    daysText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "3":
          ...
          break;
        case "5":
          days = this.day.specificSpecific.join();
          break;
        case "6":
          days = "L";
          break;
    ...
    weeksText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "2":
          ...
          break;
        case "4":
          weeks = this.week.specificSpecific.join();
          break;
        case "6":
        case "7":
        case "8":
    ...
    monthsText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "2":
          ...
          break;
        case "3":
          months = this.month.specificSpecific.join();
          break;
        case "4":
